...
namespace System.Data.FileDatabase
{
    ...
    public abstract class JetDatabase : OleDbContext, IJetDatabase, ICachedQueries
    {
        ...
        public static class Providers
        {
            ...
            /// </summary>
            public const string AccessEngine14 = "Microsoft.ACE.OLEDB.14.0";
            /// <summary>
            /// Represents the Jet Database Engine 15.0
            /// </summary>
            public const string AccessEngine15 = "Microsoft.ACE.OLEDB.15.0";
            /// <summary>
        ...
        private Dictionary<string, DataSet> _cachedQueries = [];
        ...
        public virtual bool ContainsTable(string tableName)
        {
            ...
            // doesn't
            //
            using (OleDbConnection conn = new(this.ConnectionString))
            {
                conn.Open();
        ...
        {
            BatchToken returnValue = new(this.ConnectionString);

            //
            // Open a connection
            //
            OleDbConnection conn = new(this.ConnectionString);
            conn.Open();
        ...
        {
            return Task.FromResult(GetOleDbProviders());
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static IEnumerable<IOleDbProvider> GetOleDbProviders()
        {
